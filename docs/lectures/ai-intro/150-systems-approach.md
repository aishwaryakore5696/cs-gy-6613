...
metaTitle: "A systems approach to AI"
metaDescription: "At the end AI requires a systems-design approach and a universal language / prootocol to communicate between subsystems."
---
